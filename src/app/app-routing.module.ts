...
const routes: Routes = [
  ...
  children: [
    ...
    { path: 'product-collections', component: ProductCollectionsComponent, data: { title: 'Collections'}},
     ...
     { path: 'product-personalised', component: ProductCollectionsComponent, data: { title: 'Personalised'}},
     { path: 'product-gifts', component: ProductCollectionsComponent, data: { title: 'Gifts'}},
     { path: 'product-new-arrivals', component: ProductCollectionsComponent, data: { title: 'New-arrivals'}},
